            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown" ><a href="index.php?content=sanpham" >Sản Phẩm<!-- <strong class="caret"|| class="dropdown-toggle" data-toggle="dropdown"></strong> --></a>
                           <!-- <ul class="dropdown-menu">
                            <li><a href="index.php?content=sanpham">Tất Cả</a></li>
                            <li><a href="index.php?content=sanpham">SamSung</a></li>
                            <li><a href="index.php?content=sanpham">Nokia</a></li>
