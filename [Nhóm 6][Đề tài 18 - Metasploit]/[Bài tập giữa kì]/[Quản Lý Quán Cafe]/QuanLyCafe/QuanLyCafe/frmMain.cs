...
namespace QuanLyCafe
{
    public partial class frmMain : Form
    {
       ...
       String TENDANGNHAP = "", MATKHAU = ""; int QUYEN;
        private AccountAdmin loginacc;
        internal AccountAdmin Loginacc { get => loginacc; set => loginacc = value; }
        ...
        private void DangXuatToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            string action = " dang xuat ";
            DataProvider.Instance.ExecuteQuery(@"INSERT INTO User_Activity_Log VALUES (' " + frmLogin.username + "','" + frmLogin.EmpNo + "','" + DateTime.Now + "','" + action + "','" + frmLogin.CIP + "')");
            Dispose();
        }
        ...
        private void thốngKêLươngNhânViênToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           string action = " clickthongkeluong ";
            DataProvider.Instance.ExecuteQuery(@"INSERT INTO User_Activity_Log VALUES ('" + frmLogin.username + "','" + frmLogin.EmpNo + "','" + DateTime.Now + "','" + action + "','" + frmLogin.CIP + "')");
        ...
        {
            string action = " clickbaocaodoanhthu ";
            DataProvider.Instance.ExecuteQuery(@"INSERT INTO User_Activity_Log VALUES ('" + frmLogin.username + "','" + frmLogin.EmpNo + "','" + DateTime.Now + "','" +action+ "','" + frmLogin.CIP + "')");
        ...
        private void giamSatToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmAclog frm = new frmAclog();
            this.Hide();
            frm.ShowDialog();
        ...
        private void dgvDrinkOrder_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
