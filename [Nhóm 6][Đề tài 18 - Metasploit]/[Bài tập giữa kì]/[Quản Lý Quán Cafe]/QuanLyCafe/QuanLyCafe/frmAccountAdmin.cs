...
namespace QuanLyCafe
{
    public partial class frmAccountAdmin : Form
    {
        ...
        {
            string action = " update tai khoan ";
            DataProvider.Instance.ExecuteQuery(@"INSERT INTO User_Activity_Log VALUES ('" + Convert.ToString(txtUsername.Text) + "','" + frmLogin.EmpNo + "','" + DateTime.Now + "','" + action + "','" + frmLogin.CIP + "')");
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (AccountAdminDAO.Instance.insertAccountAdmin(username, password, quyen))
            {
